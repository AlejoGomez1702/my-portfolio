...
const T = {
  es: {
    ...
    'about.who':      'Quién Soy',
    'about.bio':      'Soy Arquitecto de Software y Desarrollador Full-Stack con +5 años de experiencia liderando equipos y diseñando soluciones tecnológicas mantenibles, escalables, resilientes y eficientes. Mi experiencia se centra en el desarrollo de software de alta calidad, la implementación de prácticas CI/CD, la optimización de entornos en la nube y la adopción de metodologías ágiles como Scrum. Me enfoco en entregar productos que se alineen con las necesidades de los clientes y que apoyen el crecimiento del negocio.',
    ...
    'exp.dv1.desc': 'Liderazgo integral (técnico y de negocio) de equipos ágiles para evolucionar el canal digital principal del banco, una aplicación con más de 5 millones de descargas en Google Play. Definición y ejecución de soluciones distribuidas en AWS, con building blocks reutilizables (APIs REST/GraphQL, caché en Redis y microservicios en Spring Boot con Kotlin). Impulso de prácticas de calidad, CI/CD, escalabilidad y toma de decisiones orientadas a valor, gestionando el delivery con Jira bajo Scrum.',
  ...
  en: {
    ...
    'exp.dv1.desc': 'Cross-functional leadership (technical and business) of agile teams to evolve the bank\'s main digital channel, an app with over 5 million downloads on Google Play. Definition and delivery of distributed solutions on AWS, with reusable building blocks (REST/GraphQL APIs, Redis caching, and Spring Boot microservices with Kotlin). Promotion of quality, CI/CD, scalability, and value-driven decision-making, managing delivery with Jira under Scrum.',
